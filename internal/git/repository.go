...
func FetchRemoteContext(ctx context.Context, repoPath, remote string) error {
	out, err := remoteCommand(ctx, "-C", repoPath, "fetch", "--prune", "--no-tags", remote).CombinedOutput()
	if err != nil {
...
func FetchURLContext(ctx context.Context, repoPath, remoteURL string) error {
	...
	out, err := remoteCommand(ctx, "-C", repoPath, "fetch", "--prune", "--no-tags", remoteURL, refspec).CombinedOutput()
	if err != nil {
