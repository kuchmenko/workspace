...
Toggle Recent and Projects views with v.
...
Ctrl+S opens a shell, and A opens lifecycle maintenance. Subcommands provide
non-interactive access to the same actions.`,
		Args: cobra.NoArgs,
